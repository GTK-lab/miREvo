...
echo ""
echo "It is a good idea to put \"$MIREVO\" into your PATH after installing miREvo, by add the following line into you .bashrc file"
echo ""
...
echo "        source ~/.bashrc"
echo ""
echo "to make the above changes work."
echo ""
